...
- **未达生产级。** 尚无稳定性承诺与 semver 纪律,主力开发者一人。测试覆盖以 fixtures 为主(385/385——首次全绿);test262 符合性 harness 已就位,当前基线为 stride-5 子集(`language/` + 13 个核心 `built-ins/`;built-ins/Math 69.2%、Number 60.3%、Object 58.8%、JSON 57.6%、Set 52.6%、Map 51.2%、Array 50.3%)3,112 / 6,462 = 48.16%(见 `tests/test262/last_report.md`;经固定 corpus + `runnerSha`/`corpusPin` 可复现),较 v0.2.1 的 20.55% 已显著提升,CRASH ~161、COMPILE_FAIL ~69;数字仍低、正在持续提升。
