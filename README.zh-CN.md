...
- **未达生产级。** 尚无稳定性承诺与 semver 纪律,主力开发者一人。测试覆盖仍以 fixtures 为主(380/380);test262 符合性 harness 已就位,当前基线为 stride-5 子集(`language/` + 13 个核心 `built-ins/`)2,295 / 6,462 = 35.52%(见 `tests/test262/last_report.md`),较 v0.2.1 的 20.55% 已显著提升,CRASH 降至 177、COMPILE_FAIL 降至 43;数字仍低、正在持续提升。
