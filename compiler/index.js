...
import { sourceHasTopShimImport, sourceHasPropEscapeText, isUniTableVarName, sourceHasRegexLiteral, sourceHasLineLeadingImportExport, sourceHasJsonShimTrigger, sourceHasEvalOrFunctionCtor, sourceHasRegExpCall, sourceHasRegExpShimTrigger, sourceHasTopLevelEsmDecl, sourceByteEquals } from "./modules/shim-triggers.js";
import { isBareModuleName, isBareSubpath, cjsHasBareRequire, looksLikeCjsSource, sourceHasCallParenForm, nearestPackageJsonExplicitCommonjs, astHasRealTopLevelEsm, extractCjsNamedExportKeys, cjsStringLiteral } from "./modules/cjs-named-exports.js";
import { runtimeNodeBase, resolveModulePath } from "./modules/module-graph.js";
...
// module resolution lives in compiler/modules/module-graph.js (P2.c)
...
// isBareModuleName/isBareSubpath + CJS scanners moved to compiler/modules/cjs-named-exports.js (P2.b)
...
// NOTE: sourceHas* / shim-trigger scanners live in compiler/modules/shim-triggers.js

// sourceHas* scanners moved to compiler/modules/shim-triggers.js (P2.a)
