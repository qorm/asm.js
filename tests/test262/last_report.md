...
**asm.js passes 4173 / 6313 = 66.10% of the run test262 subset**
...
|------|----:|-----:|-----:|-------------:|------:|------:|
| built-ins/Array | 594 | 362 | 232 | 0 | 0 | 60.9 |
...
| built-ins/Object | 681 | 466 | 214 | 1 | 0 | 68.4 |
| built-ins/Promise | 127 | 69 | 58 | 0 | 0 | 54.3 |
| built-ins/RegExp | 374 | 201 | 172 | 0 | 1 | 53.7 |
| built-ins/Set | 76 | 42 | 32 | 0 | 2 | 55.3 |
| built-ins/String | 243 | 153 | 89 | 0 | 1 | 63.0 |
| built-ins/Symbol | 16 | 11 | 4 | 0 | 1 | 68.8 |
| built-ins/TypedArray | 191 | 68 | 104 | 0 | 19 | 35.6 |
...
- **1317×** FAIL: assertion mismatch (Test262Error / wrong value)
- **265×** FAIL: async ($DONE not signalled / promise rejected)
- **209×** FAIL: property-descriptor reflection (verifyProperty: length/name/writable/enumerable/configurable)
- **83×** FAIL: array contents mismatch (compareArray)
